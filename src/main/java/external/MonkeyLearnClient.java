...
public class MonkeyLearnClient {
	private static final String API_KEY = "7a845b0043c0cb966061ba9ae9bcba9923b79005";// make sure change it to your api key.
    public static void main(String[] args) {
		
		String[] textList = {
				"Elon Musk has shared a photo of the spacesuit designed by SpaceX. This is the second image shared of the new design and the first to feature the spacesuit’s full-body look.","Former Auburn University football coach Tommy Tuberville defeated ex-US Attorney General Jeff Sessions in Tuesday nights runoff for the Republican nomination for the U.S. Senate. ",
	...
	public static List<List<String>> extractKeywords(String[] text) {
		...
		ExtraParam[] extraParams = { new ExtraParam("max_keywords", "5") };
